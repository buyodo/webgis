!function (e) {
    ...
    function o(t) {
        ...
        if (t) {
            ...
            var g = "<div align='right' class='pagingDiv'>" + (
                A + 1
            ) + " - " + (
                A + r
    ...
    function r(e) {
        "Point" === k[e].geometry.type && -1 !== b.pointGeometryZoomLevel
            ? map.setView([
                k[e].geometry.coordinates[1],
                k[e].geometry.coordinates[0]
            ], b.pointGeometryZoomLevel)
            : map.fitBounds(l(k[e].geometry)),
        u(e)
    }
    function l(e) {
        var t = L.geoJson(e, {
    ...
    function m() {
        ...
        e("#resultsDiv").remove(),
        void 0 !== B && (map.removeLayer(B), B = void 0),
        void 0 !== x && (map.removeLayer(x), x = void 0)
    }
    function g() {
        t(b.pagingActive)
    }
    function f() {
        ...
        e("#resultsDiv").remove(),
        t.append("<div id='resultsDiv' class='result'><i>" + w + " " + b.notFoundMessage + " <p><small>" + b.notFoundHint + "</small></i><div>")
    }
    function y() {
        e("#searchBox")[0].value = w,
        A -= b.limit,
        ...
        e(this).each(function () {
            ...
            e("#searchBox").delayKeyup(function (o) {
                switch (o.keyCode) {
                    ...
                    case 39:
                        break;
                    default: e("#searchBox")[0].value.length > 0
                            ? (A = 0, t(!1))
                            : m()
                }
            }, 300),
    ...
    e.fn.delayKeyup = function (t, o) {
        var s = 0;
        return e(this).keyup(function (e) {
