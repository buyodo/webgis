...
var u54Grid = L.utmGrid(54, false, {
  ...
  latLonClipBounds: [[0, -180 + (53 * 6)],[80, -180 + (53 * 6) + 6]],
  drawClip: false, 
...
/*オーバーレイ追加 2 */
var sedimentrisk = L.tileLayer('../sedimentrisk/{z}/{x}/{y}.png', {   
  opacity:0.7,    
  maxZoom: 18,
  attribution: ""
  });
...
/*オーバーレイ追加 3 */
var sedimentwarning = L.tileLayer('../sedimentwarning/{z}/{x}/{y}.png', {   
  opacity:0.7,    
  maxZoom: 18,
  attribution: ""
  });  
...
/*オーバーレイ追加 4 */
var tsunami = L.tileLayer('../tsunami/{z}/{x}/{y}.png', {   
  opacity:0.7,    
  maxZoom: 18,
  attribution: ""
  });  
...
map = L.map("map", {
  ...
  layers: [cartoLight, osm, boroughs, markerClusters, highlight],
  zoomControl: false,
